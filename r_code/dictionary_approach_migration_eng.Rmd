...
```{r}
values_dict = dictionary(file = "r_code/valuesdictionary.yaml", format = "YAML", sep = ",")

values_results <- convert(dfm_lookup(corpus(trim_df), dictionary = values_dict), to = "data.frame")

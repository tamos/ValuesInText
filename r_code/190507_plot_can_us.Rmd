...
method = "continuous", xlab = "Date", moderator = "speakerparty", ci.level = 0.95, moderator.value = "conservative", linecol = "black", ylim = c(0.0, .3),  main = "Immigration Types (5)",  printlegend = F, xaxt = 'n')

...
for (i in c(5, 10, 8, 14, 17, 18, 1, 7, 12, 13, 16, 20, 6, 9, 11, 2, 15)){
  ...
  plot(interaction_content_spec_can, type = "perspectives", covarlevels = c(1,2), topics = i, plabels = c(" cons.", "lib."), text.cex = 0.9, n= 10, main = plot_labels_CAN[i], bty = 'n')
  dev.off()
}
```
...
```{r}
png(paste(c(plot_dir, 'expected_proportion_combined.png'), collapse = ""), res = 50)
par(mfrow=c(1,2))
...
plot(interaction_content_spec_us,  custom.labels = c("Immigration Types", "Law Enforcement", "Procedural 1", "Wildlife Refuge", "Voting",
                ...
                "Welfare", "Humanitarianism", "Procedural 5"), type = "summary", main = "Top Topics - US Corpus", xlim = c(0, .3), bty = 'n')
...
plot(interaction_content_spec_can,  custom.labels = c('Budget', 'Humanitarianism', 'First Nations', 'Procedural 1', 'Immigration Types',
                    ...
                    'International Conflicts', 'Procedural 2','International Trade'), type = "summary", main = "Top Topics - Canada Corpus", xlim = c(0, .3), bty = 'n')

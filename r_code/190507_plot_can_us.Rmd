...
```{r}
png(paste(c(plot_dir, "trafficking_plot_can", i, ".png"), collapse = "_"), res = 75)
plot(interaction_content_spec_can, type = "perspectives", covarlevels = c(1,2), topics = 15, plabels = c("cons.", "lib."), text.cex = 0.9, n= 10, main = "Human Trafficking (15)", bty = 'n')
...
for (i in c(5, 10, 8, 14, 17, 18, 1, 7, 12, 13, 16, 20, 6, 9, 11, 2, 15)){
  ...
  plot(interaction_content_spec_can, type = "perspectives", covarlevels = c(1,2), topics = i, plabels = c("conservative", "liberal"), text.cex = 0.9, n= 10, main = plot_labels_CAN[i], bty = 'n')
  dev.off()
}
```
...
```{r}
png(paste(c(plot_dir, "trafficking_plot_us", i, ".png"), collapse = "_"), res = 75)
plot(interaction_content_spec_us, type = "perspectives", covarlevels = c(3,1), topics = 7, plabels = c(" Repub.", "Democ."), text.cex = 0.9, n= 10, main = "Human Trafficking (7)", bty = 'n')
...
for (i in c(1,2,10,16,17, 12, 13, 18,5, 6, 15, 7, 8, 19)){
  ...
  plot(interaction_content_spec_us, type = "perspectives", covarlevels = c(3,1), plabels = c("Republicans", "Democrats"), topics = i,   text.cex = 1, n= 10, main = plot_labels[i])
  dev.off()
}
```
...
png(paste(c(plot_dir, 'topic_classifications.png'), collapse = ""))
...
#Both_Plot
```
 To convert all images to grayscale use imagemajick
 
for i in $(ls); do convert $i -fx '(r+g+b)/3' -colorspace Gray 'gray_'$i ; done
